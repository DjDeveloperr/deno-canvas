  ...
  return (
    function (CanvasKitInit) {
          ...
          a.MakeWebGLCanvasSurface = function (c, d, h) {
            ...
            if (
              !("undefined" !== typeof HTMLCanvasElement &&
                ...
                q || (m = document.getElementById(c), m))
            ) {
      ...
      (function (a) {
        ...
        function d(g) {
          return (b(255 * g[3]) << 24 | b(255 * g[0]) << 16 |
            b(255 * g[1]) << 8 | b(255 * g[2]) << 0) >>> 0;
        }
        function h(g) {
        ...
        function I(g) {
          ...
          if (g.length) {
            if (
              16 !== g.length && 6 !== g.length && 9 !== g.length
            ) {
        ...
        a.parseColorString = function (g, r) {
          ...
          return g.startsWith("rgba")
            ...
            ? (g = g.slice(4, -1),
              g = g.split(","),
              a.Color(+g[0], +g[1], +g[2], m(g[3])))
            : g.startsWith("gray(") || g.startsWith("hsl") || !r ||
                (g = r[g], void 0 === g)
            ? a.BLACK
            : g;
        };
        ...
        a.Bg.prototype.set = function (g, r) {
          0 > g || g >= this.Hg.length ||
            (g *= 4, this.Mf ? a.HEAPU32[this.Mf / 4 + g] = r : this.Hg[g] = r);
        };
        ...
        a.onRuntimeInitialized = function () {
          ...
          a.SkMatrix.invert = function (e) {
            var l = e[0] * e[4] * e[8] + e[1] * e[5] * e[6] +
              e[2] * e[3] * e[7] - e[2] *
                e[4] * e[6] -
              e[1] * e[3] * e[8] - e[0] * e[5] * e[7];
            return l
              ? [
                (e[4] * e[8] - e[5] * e[7]) / l,
                (e[2] * e[7] - e[1] * e[8]) / l,
          ...
          var ca = [[6, 7, 11, 12], [0, 10, 2, 12], [0, 1, 5, 6]];
          ...
          a.SkColorMatrix.concat = function (e, l) {
            for (var t = new Float32Array(20), w = 0, C = 0; 20 > C; C += 5) {
              for (var p = 0; 4 > p; p++) {
                t[w++] = e[C] * l[p] + e[C + 1] * l[p + 5] +
                  e[C + 2] * l[p + 10] + e[C + 3] * l[p + 15];
              }
              t[w++] = e[C] * l[4] + e[C + 1] * l[9] + e[C + 2] * l[14] +
                e[C + 3] * l[19] + e[C + 4];
            }
            return t;
          };
          ...
          a.SkPath.prototype.addPath = function () {
            var e = Array.prototype.slice.call(arguments), l = e[0], t = !1;
          ...
          a.SkPath.prototype.addVerbsPointsWeights = function (e, l, t) {
            var w = q(e, "HEAPU8"), C = q(l, "HEAPF32"), p = q(t, "HEAPF32");
          ...
          a.SkImage.prototype.readPixels = function (e, l, t) {
            ...
            var C = w * e.height, p = a._malloc(C);
          ...
          a.SkCanvas.prototype.drawShadow = function (e, l, t, w, C, p, F) {
            var L = q(C, "HEAPF32"), P = q(p, "HEAPF32");
          ...
          a.SkColorFilter.MakeMatrix = function (e) {
            ...
            var l = q(e, "HEAPF32"), t = a.SkColorFilter._makeMatrix(l);
            U(l, e);
            return t;
          };
          ...
          a.SkSurface.prototype.captureFrameAsSkPicture = function (e) {
            var l = new a.SkPictureRecorder(),
              t = l.beginRecording(
                a.LTRBRect(0, 0, this.width(), this.height()),
              );
            e(t);
          ...
          a.SkShader.MakeSweepGradient = function (
            e,
            l,
            t,
            w,
          ...
          a.Of && a.Of.forEach(function (e) {
            e();
          });
        };
        a.computeTonalColors = function (g) {
          var r = q(g.ambient, "HEAPF32"), A = q(g.spot, "HEAPF32");
        ...
        (function (g) {
          ...
          g.Of.push(function () {
            ...
            g.ParagraphStyle = function (p) {
              ...
              F.strutEnabled && Array.isArray(F.fontFamilies) &&
            ...
            var l = {}, t = g._malloc(16), w = g._malloc(16), C = g._malloc(16);
        ...
        a.Of.push(function () {
          ...
          a.SkFont.prototype.getGlyphBounds = function (g, r, A) {
            var D = q(g, "HEAPU16"), M = a._malloc(16 * g.length);
          ...
          a.SkFont.prototype.getGlyphWidths = function (g, r, A) {
            var D = q(g, "HEAPU16"), M = a._malloc(4 * g.length);
          ...
          a.SkFont.prototype.getWidths = function (g) {
            var r = g.length + 1, A = la(g) + 1, D = a._malloc(A);
            na(g, v, D, A);
            g = a._malloc(4 * r);
          ...
          a.SkFontMgr.FromData = function () {
            ...
            for (var r = [], A = [], D = 0; D < g.length; D++) {
              var M = new Uint8Array(g[D]), ca = q(M, "HEAPU8");
              r.push(ca);
              A.push(M.byteLength);
            }
            r = q(r, "HEAPU32");
          ...
          a.SkTextBlob.MakeOnPath = function (g, r, A, D) {
            if (g && g.length && r && r.countPoints()) {
              ...
              D || (D = 0);
              var M = A.getWidths(g), ca = new a.RSXFormBuilder();
              ...
              for (var e = 0; e < g.length; e++) {
                ...
                var t = r.getPosTan(D), w = t[2], C = t[3];
          ...
          a.SkTextBlob.MakeFromRSXform = function (g, r, A) {
            ...
            r = a.SkTextBlob._MakeFromRSXform(
              M,
              D -
                1,
              g,
        ...
        (function () {
          ...
          function r(J) {
            ...
            k = k[3];
            if (1 === k) {
              return J = J.toString(16).toLowerCase(),
          ...
          function M(J) {
            ...
            this.drawImage = function (k) {
              var n = this.yh();
              if (
                3 === arguments.length || 5 === arguments.length
              ) {
                var x = a.XYWHRect(
                    arguments[1],
                    arguments[2],
            ...
            this.isPointInPath = function (k, n, x) {
              ...
              else if (4 === B.length) G = B[0], k = B[1], n = B[2], x = B[3];
            ...
            this.isPointInStroke = function (k, n) {
              ...
              if (2 === x.length) var B = this.Kf;
                ...
                throw "invalid arg count, need 2 or 3, got " +
                  x.length;
              }
              if (!isFinite(k) || !isFinite(n)) return !1;
              x = this.ph([k, n]);
            ...
            this.sg = function (k) {
              ...
              if (
                !a.getColorComponents(n)[3] || !(this.pg || this.rg || this.qg)
              ) {
                return null;
              }
              k = k.copy();
          ...
          function ca(J) {
            ...
            this.loadFont = function (k, n) {
              ...
              if (!k) return null;
              this.Rg.push(k);
              var x = (n.style || "normal") + "|" + (n.variant || "normal") +
                "|" + (n.weight || "normal");
              n = n.family;
              oa[n] || (oa[n] = { "*": k });
              oa[n][x] = k;
          ...
          a.ImageData = function () {
            if (2 === arguments.length) {
              var J = arguments[0], k = arguments[1];
              return new e(new Uint8ClampedArray(4 * J * k), J, k);
            }
            if (3 === arguments.length) {
              var n = arguments[0];
              if (
                n.prototype.constructor !== Uint8ClampedArray
              ) {
      ...
      if (za) {
        ...
        "undefined" != typeof read && (Ca = function (a) {
          return read(a);
        }),
          Da = function (a) {
      ...
      var wb = Math.ceil, xb = Math.floor, yb = 0, zb = null, Ab = null;
      f.preloadedImages = {};
      f.preloadedAudios = {};
      function Ia(a) {
      ...
      function Hb() {
        return Ma || !xa && !ya || "function" !== typeof fetch || Bb("file://")
          ...
          : fetch(Db, { credentials: "same-origin" }).then(function (a) {
            ...
            a[b].Rf.hasOwnProperty(arguments.length) ||
              W(
                "Function '" + c +
                  ...
                  arguments.length + ") - expects one of (" + a[b].Rf + ")!",
              );
      ...
      function Fc(a, b) {
        ...
        b.Ef.Pf.Sg &&
          W(
            "Cannot convert argument of type " + b.Ef.Pf.name +
              " to parameter type " + this.name,
          );
        return Ac(b.Ef.If, b.Ef.Pf.Jf, this.Jf);
      }
      ...
      function Uc(a, b) {
        ...
        h = "return function dynCall_" + (a + "_" + b) + "(" + d.join(", ") +
          ") {\n";
        h += "    return dynCall(rawFunction" + (d.length ? ", " : "") +
          d.join(", ") + ");\n";
      ...
      function ad(a, b, c, d, h) {
        ...
        var y = "void" !== b[0].name, E = "", I = "";
        for (c = 0; c < m - 2; ++c) {
          E += (0 !== c ? ", " : "") + "arg" + c,
            I += (0 !== c ? ", " : "") + "arg" + c + "Wired";
        }
        a = "return function " + Ub(a) + "(" + E +
        ...
        a += (y ? "var rv = " : "") + "invoker(fn" + (0 < I.length
          ? ", "
          : "") +
          I + ");\n";
      ...
      var cd = [],
        dd = [{}, { value: void 0 }, { value: null }, { value: !0 }, {
          value: !1,
        }];
      function ed(a) {
            ...
            switch (d = Y.getParameter(a), typeof d) {
              ...
              case "object":
                if (null === d) {
                  ...
                  if (
                    d instanceof Float32Array || d instanceof Uint32Array ||
              ...
              default:
                ...
                Ka(
                  "GL_INVALID_ENUM in glGet0v: Native code calling glGet0v(" +
                    a + ") and it returns " + d + " of type " + typeof d + "!",
                );
                return;
            }
          }
      ...
      function Pd(a, b, c, d, h) {
        a = Od(a);
        var m = 31 - Math.clz32(a.BYTES_PER_ELEMENT), q = Fd;
        return a.subarray(
          h >> m,
          h + d *
                (c *
      ...
      function Zd(a, b) {
        for (a = new Date(a.getTime()); 0 < b;) {
          var c = a.getMonth(), d = (Vd(a.getFullYear()) ? Xd : Yd)[c];
          if (b > d - a.getDate()) {
            b -= d - a.getDate() + 1,
              a.setDate(1),
              11 > c
      ...
      vc.prototype.isAliasOf = function (a) {
        ...
        var b = this.Ef.Pf.Jf, c = this.Ef.If, d = a.Ef.Pf.Jf;
      ...
      var ze = {
          ...
          Zb([a], h, function (u) {
            ...
            return [{
              ...
              toWireType: function (y, E) {
                if (d !== E.length) {
                  throw new TypeError(
                    "Incorrect number of tuple elements for " + b.name +
                      ": expected=" + d + ", actual=" + E.length,
                  );
                }
        ...
        k: function (a, b, c, d, h, m, q, u, y, E, I, N, Q) {
          ...
          Zb([a, b, c], d ? [d] : [], function (R) {
            ...
            R = Vb(z, function () {
              ...
              if (void 0 === Cb) {
                throw new lc(
                  "Tried to invoke ctor of " + I +
                    " with invalid number of parameters (" + arguments.length +
                    ") - expected (" + Object.keys(U.ig).toString() +
                    ") parameters instead!",
                );
              }
        ...
        j: function (a, b, c, d, h, m, q) {
          ...
          Zb([], [a], function (y) {
            ...
            y = y[0];
            var I = y.name + "." + b, N = y.Jf.constructor;
            void 0 === N[b]
              ? (E.wg = c - 1, N[b] = E)
            ...
            Zb([], q, function (N) {
              E.Jf.ig[b - 1] = function () {
                arguments.length !== b - 1 &&
                  W(
                    I + " called with " + arguments.length +
        ...
        y: function (a, b, c, d, h) {
          ...
          $b(a, {
            ...
            toWireType: function (E, I) {
              ...
              if (I < d || I > h) {
                throw new TypeError(
                  'Passing a number "' + Cc(I) +
                    '" from JS side to C/C++ side to an argument of type "' +
                    b + '", which is outside the valid range [' + d + ", " + h +
                    "]!",
                );
              }
              return y ? I >>> 0 : I | 0;
        ...
        z: function (a, b) {
          ...
          for (
            var c = b[0],
              d = c.name + "_$" + b.slice(1).map(function (E) {
                return E.name;
              }).join("_") + "$",
              h = ["retType"],
              m = [c],
          ...
          d = "return function " + Ub("methodCaller_" + d) +
        ...
        ec: function (a, b) {
          for (var c = 0; c < a; c++) {
            var d = K[b + 4 * c >> 2], h = wd[d];
            h && (Y.deleteRenderbuffer(h), h.name = 0, wd[d] = null);
          }
        },
        Pb: function (a, b) {
          for (var c = 0; c < a; c++) {
            var d = K[b + 4 * c >> 2], h = Ad[d];
        ...
        Ga: function (a, b, c) {
          c
            ? 35716 == b
              ...
              : 35720 == b
              ? (a = Y.getShaderSource(yd[a]), K[c >> 2] = a ? a.length + 1 : 0)
        ...
        cb: function (a, b) {
          ...
          switch (a) {
            case 7939:
              return c = Y.getSupportedExtensions() || [],
        ...
        Ha: function (a, b) {
          ...
          return (a = Cd[a] && Cd[a].th[b]) && 0 <= c && c < a[0]
            ? a[1] + c
            : -1;
        },
        Mb: function (a, b, c) {
      ...
      (function () {
        ...
        (function () {
          if (
            Ma || "function" !== typeof WebAssembly.instantiateStreaming ||
            Eb() || Bb("file://") || "function" !== typeof fetch
          ) {
            return c(b);
          }
